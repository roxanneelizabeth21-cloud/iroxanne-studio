...
export default async function (req: Request) {
  try {
    ...
    const safe = {
      ...
      square_payment_snapshot:invoice.square_payment_snapshot || [],
      square_public_url:invoice.square_sync_error ? '' : invoice.square_public_url || '',
      square_last_checked_at:invoice.square_last_checked_at,
      square_needs_review:!!invoice.square_sync_error,
