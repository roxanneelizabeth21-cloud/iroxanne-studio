// Shared branded HTML email shell so every email the app sends looks like Roxsan:
...
// Same logo asset the site header uses (gold, designed for a dark background).
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#F7F5F0;padding:28px 12px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#FFFFFF;border-radius:14px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
        <tr><td style="background:${BRAND_DARK};padding:26px 32px;text-align:center;">
          <img src="${LOGO_URL}" alt="Roxsan" width="200" style="display:block;margin:0 auto;width:200px;max-width:70%;height:auto;border:0;" />
        </td></tr>
