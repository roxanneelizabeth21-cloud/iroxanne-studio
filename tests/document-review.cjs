...
assert.ok(emails[0].body.includes('https://iroxannestudio.com/contract/review?t=private-token'));
assert.ok(emails[0].body.includes('/invoice/invoice-review?t='));
