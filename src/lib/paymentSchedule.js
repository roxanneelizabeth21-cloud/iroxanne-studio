// Mirrors base44/shared/paymentSchedule.ts — keep in sync if the logic changes.
// Frontend copy because relative imports of base44/shared modules 403 in the preview sandbox.
...
export function validateSchedule(rows, total) {
...
export function scheduleText(rows) {
