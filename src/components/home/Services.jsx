...
export default function Services(){
  return <section id="services" className="scroll-mt-24 max-w-6xl mx-auto px-5 md:px-8 py-14">
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-7 mt-10">
    ...
    <a href="/quote" className="inline-flex min-h-12 items-center rounded-full bg-[#2D2A4A] text-white px-7 mt-8 font-semibold">Tell me what you’re imagining →</a>
    <p className="mt-4 text-sm text-muted-foreground">Already building it yourself? <a href="/quote?support=guidance" className="underline underline-offset-4">Ask about guidance.</a></p>
  </section>;
}
