  ...
  return (
    <div className="min-h-screen bg-[#FAF7F0] text-[#2D2A4A]">
      ...
      <main className="mx-auto max-w-3xl px-5 md:px-8 pt-[130px] pb-20">
        ...
        <h1 className="text-[34px] md:text-[42px] font-semibold text-[#2D2A4A] tracking-tight" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Hi, I'm Roxanne.</h1>
        ...
        <div className="mt-8 space-y-5 text-[15.5px] leading-[1.75] text-[#2D2A4A]/70" style={{ fontFamily: "'Inter', sans-serif" }}>
          <p>
            I'm <span className="font-semibold text-[#2D2A4A]">Roxanne</span>, the founder and builder behind iRoxanne Studio. I build custom apps for people who have an idea and want help turning it into something real. Whether you are launching a new business, running a small team, or just exploring a concept, I work with you to shape the idea, decide what belongs in a first version, and build it step by step with your feedback along the way.
          </p>
          <p>
          ...
          <a href="/quote" className="inline-flex items-center gap-2 text-[14px] font-semibold text-[#2D2A4A] hover:text-[#B8942E] transition mt-2" style={{ fontFamily: "'Inter', sans-serif" }}>
            Let's talk about your idea <ArrowRight className="h-4 w-4 text-[#B8942E]" />
          </a>
        </div>
      </main>
      <SiteFooter />
