    ...
    <div className="min-h-screen bg-[#FAF7F0] text-[#2D2A4A]">
      ...
      <main>
        ...
        <section aria-labelledby="support-heading" className="mx-auto max-w-6xl px-5 py-12 md:px-8">
          ...
          <p className="mt-3 max-w-2xl text-[#655769] leading-relaxed">You may have a clear plan, a half-built app, or just an idea. We can work out a useful next step together.</p>
          <div className="mt-7 grid gap-5 md:grid-cols-2">
            <article className="rounded-2xl border border-[#C9B78C]/40 bg-white/60 p-6">
              <h3 className="text-2xl font-semibold" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Let me help you build it</h3>
              <p className="mt-3 text-[#655769] leading-relaxed">I can help shape your idea, decide what belongs in a first version, and design and build the app with your feedback along the way.</p>
            ...
            <article className="rounded-2xl border border-[#C9B78C]/40 bg-white/60 p-6">
              ...
              <p className="mt-3 text-[#655769] leading-relaxed">Prefer to be hands-on? I can help you plan your first version, think through features, or review what you have started. We will agree on the help you need and its cost before we begin.</p>
