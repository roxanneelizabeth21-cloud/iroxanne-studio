...
const FEATURE_OPTIONS = [
  'In-app service calendar and appointment booking',
  'Customer records and expanded intake forms',
  ...
  'Nonprofit donations and volunteer management',
];
...
const emptyForm = {
  selected_package: 'Business Website',
  name: '',
  email: '',
  phone: '',
  business_name: '',
...
const BUDGET_LABELS = {
  under_1500: '$650 website or website with add-ons (under $1,500)',
