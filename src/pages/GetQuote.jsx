    ...
    <div className="min-h-screen bg-[#FAF7F0] py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[34px] md:text-[42px] font-semibold text-[#2D2A4A] tracking-tight" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Let's Build Something for Your Business</h1>
          <p className="text-[15px] text-[#2D2A4A]/50 mt-3" style={{ fontFamily: "'Inter', sans-serif" }}>Four quick steps — takes about 3 minutes. The more detail you share, the more accurate your proposal will be.</p>
        </div>
